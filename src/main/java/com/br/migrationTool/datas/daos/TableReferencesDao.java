...
public class TableReferencesDao {
    ...
    public List<BasicTableStructureDto> getParentTablesFromConstraint(
        ...
        ResultSetHandler<List<BasicTableStructureDto>> rsh = new BeanListHandler<>(BasicTableStructureDto.class);
    ...
    public List<BasicTableStructureDto> getChildrenTablesFromConstraint(
        String tableName, boolean isProd
    ) throws SQLException {
    ...
    public List<String> getPrimaryKeys(
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        List<String> namesColumnsTable = new ArrayList<>();
        ...
        try {
            ...
            while (rs.next()) {
                namesColumnsTable.add(rs.getString(primaryKeyName));
            }
        } finally {
            connectionOracleJDBC.close(ps, rs);
        }

        return namesColumnsTable;
    }
}
